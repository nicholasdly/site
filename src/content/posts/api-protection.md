...
A right of passage for any new web developer is building an <abbr title="Application Programming Interface">API</abbr>. After all, the very first thing I worked on when I started as a web developer was an API.

I'd like to think I learned a lot since then.
